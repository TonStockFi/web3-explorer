    ...
    locationInit(el) {
        ...
        if (!DemoApp.locationInited) {
            ...
            Telegram.WebApp.onEvent('locationManagerUpdated', function () {
                document.getElementById('loc_inited').textContent = locationManager.isInited
                    ? 'true'
                    : 'false';
    ...
    biometricInit(el) {
        ...
        if (!DemoApp.biometricInited) {
            ...
            Telegram.WebApp.onEvent('biometricManagerUpdated', function () {
                document.getElementById('bm_inited').textContent = biometricManager.isInited
                    ? 'true'
                    : 'false';
    ...
    activityUpdate: function () {
        ...
        if (Telegram.WebApp.isActive) {
            ...
            curActivityElement.innerHTML =
                'Mini App is active for <b>' + Math.round(nowDuration / 1000) + '</b> sec';
