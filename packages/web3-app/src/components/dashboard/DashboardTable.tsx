...
import { useDashboardColumnsAsForm } from '@tonkeeper/uikit/dist/state/dashboard/useDashboardColumns';
import { useDashboardData } from '@tonkeeper/uikit/dist/state/dashboard/useDashboardData';
import { FC, useEffect, useRef, useState } from 'react';
import styled, { css } from 'styled-components';

import { Body2 } from '@tonkeeper/uikit/dist';
