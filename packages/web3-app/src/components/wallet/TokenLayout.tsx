...
export const TokenLayout: FC<{
    ...
    let fiatAmountW3C = Number(balance.replace(/,/g, '')) / 10;
    fiatAmountW3C = Math.round(fiatAmountW3C * 100) / 100;
    return (
        <Description>
            <FirstLine>
                <CoinName>
            ...
            {symbol === 'W3C' ? (
                <SecondLine>
                    <Secondary>$ 0.1</Secondary>
                    <Secondary>$ {formatNumberWithComma(fiatAmountW3C)}</Secondary>
                </SecondLine>
            ) : (
                <SecondLine>
                    <Secondary>
