...
export const sendEvent = async (webview: any, type: 'mouseDown' | 'mouseUp', x: number, y: number, button: 'left', clickCount: number = 1) => {
...
export const sendClick = async (webview: any, x: number, y: number) => {
    await webview.sendInputEvent({
        type: 'mouseDown',
        x,
        y,
